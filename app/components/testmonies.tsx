export default function Testimonials() {
    return (
        // <div className="p-12 pt-16 lg:py-24 mt-25">
        //   <div className="bg-red-800 rounded-lg pb-16 lg:relative lg:z-10 lg:pb-0">
        ...
        //               <p className="text-base font-medium text-red-100">CEO at PureInsights</p>
        //             </footer>
        //           </blockquote>
        //         </div>
        //       </div>
